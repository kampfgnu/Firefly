...
@property (nonatomic, readwrite) BOOL pausedByInterruption;
...
@synthesize pausedByInterruption;
...
- (BOOL)openReadStream
{
	@synchronized(self)
	{
		...
		{
            NSLog(@"range: %@", [NSString stringWithFormat:@"bytes=%ld-%ld", seekByteOffset, fileLength]);
